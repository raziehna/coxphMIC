...
#' @details
#' The main idea of MIC involves approximation of the 0 norm with a continuous or smooth
...
#' \url{http://www.tandfonline.com/doi/pdf/10.1080/10618600.2014.955176}
#' \item Su, X., Wijayasinghe, C. S., Fan, J., and Zhang, Y. (2015). Sparse estimation of Cox proportional
#' hazards models via approximated information criteria. \emph{Biometrics}.
#' \url{http://onlinelibrary.wiley.com/doi/10.1111/biom.12484/epdf}
#' }
	...
	details=FALSE)
{
	...
	out <- list(min.Q=min.Q, gamma=beta2, beta=beta.SU)
	...
	if (compute.se.gamma) {
		...
		result <- cbind(result, se.gamma=round(se.bfbeta, rounding.digits),
			z.stat=round(z.stat, rounding.digits),
